    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==1) 
                {
                    echo '<h2>Welcome to Quiz Platform</h2>';
                    echo '<p>Welcome, ' . $name . '! Explore and start your quizzes here.</p>';
                ...
                if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
                    ...
                    // Fetch the timeout value
                    $timeout_query = mysqli_query($con, "SELECT timeout FROM quiz WHERE eid='$eid'");
